...
If you are a technical writer, program manager, or developer from the product team for an [!DNL Adobe Experience Cloud] solution and it's your job to contribute to or author technical articles, you should use the private repository at `https://git.corp.adobe.com/AdobeDocs`.

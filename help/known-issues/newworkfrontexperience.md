...
| **Issue** | **Last Modified** |
| -----------------------------------------------------------------| ----------------- |
| [Reports: Reports uses report creator instead of wildcard "$$[!UICONTROL USERID]"](known-issues-workfront/wf-reports-repeat-report-uses-creater-instead-of-wildcard.md) | December 13, 2022 |

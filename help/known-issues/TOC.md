...
+ [!DNL Adobe Workfront] {#new-workfront-experience} 
    ...
    + Current Issues in [!DNL Adobe Workfront] {#wf-current}
        ...
        + [Proofs: Proof generation is slow](/help/known-issues/known-issues-workfront/wf-proofs-generation-takes-long-time.md)
        ...
        + [Documents: Approval "quick add" does not include deadline entry for new versions](known-issues-workfront/wf-documents-quick-add-lacks-deadline.md)
        + [Layout templates: Administrators unable to edit Home layout templates](known-issues-workfront/wf-layout-templates-unable-to-edit-home.md)
        + [Users: "Unregistered" tag persists after login](known-issues-workfront/wf-users-unregistered-tag-persists-after-login.md)
        ...
        + [Reports: Reports fail to load](known-issues-workfront/wf-reports-fail-to-load.md)

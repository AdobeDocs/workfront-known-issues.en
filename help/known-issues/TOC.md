...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
    ...
    + Current Issues in [!DNL Adobe Workfront] {#wf-current}
        ...
        + [Proofs: Issues processing static files](known-issues-workfront/inactive.wf-proofs-discrepancies-in-new-tool.md)
        ...
        + [Reports: Cannot scroll report horizontally when viewing on dashboard](known-issues-workfront/inactive.wf-reports-cannot-scroll-horizontally.md)
...
+ [!DNL Adobe Workfront Fusion] {#fusion}
    ...
    + Current Issues in [!DNL Workfront Fusion] {#fusion-current}
        + [Workfront Fusion: Workfront Proof > Watch Proof module times out](/help/known-issues/known-issues-workfront-fusion/fusion-wfp-watch-proof-times-out.md)

...
When an admin removes a user in the Adobe Admin Console, that user is not removed from Workfront. The user is still visible and active in Workfront.

_First reported on February 3, 2026._
